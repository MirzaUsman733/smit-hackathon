                            ...
                            <div class="owl-carousel price-carousel wow zoomIn" data-wow-delay="0.9s">
                                <div class="price-item pb-4">
                                    <div class="position-relative">
                                        <Image class="img-fluid rounded-top" src={image1} alt="" />
                                    ...
                                    <div class="position-relative text-center bg-light border-bottom border-primary py-5 p-4">
                                        ...
                                        <Link href="appointment" class="btn btn-primary py-2 px-4 position-absolute top-100 start-50 translate-middle">Appointment</Link>
                                    </div>
                                </div>
                                <div class="price-item pb-4">
                                    <div class="position-relative">
                                        <Image class="img-fluid rounded-top" src={image2} alt="" />
                                        <div class="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style={{zIndex: 2}}>
                                ...
                                <div class="price-item pb-4">
                                    <div class="position-relative">
                                        <Image class="img-fluid rounded-top" src={image3} alt="" />
                                        <div class="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style={{zIndex: 2}}>
